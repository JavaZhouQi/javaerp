...
@ApiModel(value="Tjcinventorybook对象", description="")
public class Tjcinventorybook extends Model<Tjcinventorybook> {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "库存台账ID")
    @TableId("inventorybookID")
    private Integer inventorybookID;
    ...
    public static final String INVENTORYBOOKID = "inventorybookID";
